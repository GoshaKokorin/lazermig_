...
from lazermig.apps.api.catalog.serializers import CategoryListSerializer
from lazermig.apps.api.news.serializers import NewsListSerializer
from lazermig.apps.catalog.models import Category
from lazermig.apps.main.models import Main
from lazermig.apps.news.models import News
