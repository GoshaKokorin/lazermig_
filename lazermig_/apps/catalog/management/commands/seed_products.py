...
#
# from lazermig_.apps.catalog.models import Product, ProductTag
# from lazermig_.utils import generate_slug
# from lazermig_.seed_utils import get_file_logo
#
# logger = logging.getLogger('seed_products')
#
#
# class Command(BaseCommand):
#     help = 'Заполнение товаров тестовыми данными.'
#
